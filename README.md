...
- [ ] GM
  - 1 [Token price](./notes/gm_liquidity/market_token_price.md) TODO: links
  - 2 [Fees](./notes/market_liquidity_fees.md)
  - 3 [Mint](./notes/gm_liquidity/market_deposit.md)
  ...
  - 4 [Burn](./notes/gm_liquidity/market_withdraw.md)
...
- [ ] GLV
  - 5 [Token pricing](./notes/glv_liquidity/glv_token_price.md) TODO: links
  - 6 [Fees](./notes/glv_liquidity_fees.md)
  - 7 [Mint](./notes/glv_liquidity/glv_deposit.md)
  ...
  - 8 [Burn](./notes/glv_liquidity/glv_withdraw.md)
