...
library Keys {
    ...
    bytes32 public constant MAX_AUTO_CANCEL_ORDERS =
        keccak256(abi.encode("MAX_AUTO_CANCEL_ORDERS"));
    bytes32 public constant
        MAX_TOTAL_CALLBACK_GAS_LIMIT_FOR_AUTO_CANCEL_ORDERS = keccak256(
            abi.encode("MAX_TOTAL_CALLBACK_GAS_LIMIT_FOR_AUTO_CANCEL_ORDERS")
        );
    ...
    bytes32 public constant ACCOUNT_SHIFT_LIST =
        keccak256(abi.encode("ACCOUNT_SHIFT_LIST"));
    bytes32 public constant GLV_LIST = keccak256(abi.encode("GLV_LIST"));
    bytes32 public constant GLV_DEPOSIT_LIST =
        keccak256(abi.encode("GLV_DEPOSIT_LIST"));
    bytes32 public constant GLV_SHIFT_LIST =
        keccak256(abi.encode("GLV_SHIFT_LIST"));
    bytes32 public constant ACCOUNT_GLV_DEPOSIT_LIST =
        keccak256(abi.encode("ACCOUNT_GLV_DEPOSIT_LIST"));
    bytes32 public constant GLV_WITHDRAWAL_LIST =
        keccak256(abi.encode("GLV_WITHDRAWAL_LIST"));
    ...
    bytes32 public constant AUTO_CANCEL_ORDER_LIST =
        keccak256(abi.encode("AUTO_CANCEL_ORDER_LIST"));
    ...
    bytes32 public constant GLV_DEPOSIT_GAS_LIMIT =
        keccak256(abi.encode("GLV_DEPOSIT_GAS_LIMIT"));
    bytes32 public constant GLV_WITHDRAWAL_GAS_LIMIT =
        keccak256(abi.encode("GLV_WITHDRAWAL_GAS_LIMIT"));
    bytes32 public constant GLV_SHIFT_GAS_LIMIT =
        keccak256(abi.encode("GLV_SHIFT_GAS_LIMIT"));
    bytes32 public constant GLV_PER_MARKET_GAS_LIMIT =
        keccak256(abi.encode("GLV_PER_MARKET_GAS_LIMIT"));
    bytes32 public constant SHIFT_GAS_LIMIT =
        keccak256(abi.encode("SHIFT_GAS_LIMIT"));
    ...
    bytes32 public constant PRO_TRADER_TIER =
        keccak256(abi.encode("PRO_TRADER_TIER"));
    bytes32 public constant PRO_DISCOUNT_FACTOR =
        keccak256(abi.encode("PRO_DISCOUNT_FACTOR"));
    bytes32 public constant LIQUIDATION_FEE_FACTOR =
        keccak256(abi.encode("LIQUIDATION_FEE_FACTOR"));
    ...
    bytes32 public constant ATOMIC_SWAP_FEE_FACTOR =
        keccak256(abi.encode("ATOMIC_SWAP_FEE_FACTOR"));
    bytes32 public constant DEPOSIT_FEE_FACTOR =
        keccak256(abi.encode("DEPOSIT_FEE_FACTOR"));
    bytes32 public constant WITHDRAWAL_FEE_FACTOR =
        keccak256(abi.encode("WITHDRAWAL_FEE_FACTOR"));
    ...
    bytes32 public constant DATA_STREAM_ID =
        keccak256(abi.encode("DATA_STREAM_ID"));
    bytes32 public constant DATA_STREAM_MULTIPLIER =
    ...
    bytes32 public constant LATEST_ADL_AT =
        keccak256(abi.encode("LATEST_ADL_AT"));
    ...
    bytes32 public constant OPTIMAL_USAGE_FACTOR =
        keccak256(abi.encode("OPTIMAL_USAGE_FACTOR"));
    bytes32 public constant BASE_BORROWING_FACTOR =
        keccak256(abi.encode("BASE_BORROWING_FACTOR"));
    ...
    bytes32 public constant GLV_MAX_MARKET_COUNT =
        keccak256(abi.encode("GLV_MAX_MARKET_COUNT"));
    ...
    bytes32 public constant IS_GLV_MARKET_DISABLED =
        keccak256(abi.encode("IS_GLV_MARKET_DISABLED"));
    ...
    bytes32 public constant GLV_SHIFT_MIN_INTERVAL =
        keccak256(abi.encode("GLV_SHIFT_MIN_INTERVAL"));
    ...
    bytes32 public constant CONTRIBUTOR_TOKEN_LIST =
        keccak256(abi.encode("CONTRIBUTOR_TOKEN_LIST"));
    ...
    bytes32 public constant BUYBACK_BATCH_AMOUNT =
        keccak256(abi.encode("BUYBACK_BATCH_AMOUNT"));
    bytes32 public constant BUYBACK_AVAILABLE_FEE_AMOUNT =
        keccak256(abi.encode("BUYBACK_AVAILABLE_FEE_AMOUNT"));
    bytes32 public constant BUYBACK_GMX_FACTOR =
        keccak256(abi.encode("BUYBACK_GMX_FACTOR"));
    bytes32 public constant BUYBACK_MAX_PRICE_IMPACT_FACTOR =
        keccak256(abi.encode("BUYBACK_MAX_PRICE_IMPACT_FACTOR"));
    bytes32 public constant BUYBACK_MAX_PRICE_AGE =
        keccak256(abi.encode("BUYBACK_MAX_PRICE_AGE"));
    ...
    function getFullKey(bytes32 baseKey, bytes memory data)
        internal
        pure
        returns (bytes32)
    {
    ...
    function accountDepositListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account for the list
    function accountWithdrawalListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account for the list
    function accountShiftListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account for the list
    function accountGlvDepositListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @dev key for the account glv deposit list
    // @param account the account for the list
    function accountGlvWithdrawalListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    function glvSupportedMarketListKey(address glv)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account for the list
    function accountPositionListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account for the list
    function accountOrderListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account for the list
    function subaccountListKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    function autoCancelOrderListKey(bytes32 positionKey)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimableFeeAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimableUiFeeAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function swapPathMarketFlagKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function createGlvDepositFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(CREATE_GLV_DEPOSIT_FEATURE_DISABLED, module));
    }
    ...
    function cancelGlvDepositFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(CANCEL_GLV_DEPOSIT_FEATURE_DISABLED, module));
    }
    ...
    function executeGlvDepositFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(EXECUTE_GLV_DEPOSIT_FEATURE_DISABLED, module));
    }
    ...
    function createGlvWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(CREATE_GLV_WITHDRAWAL_FEATURE_DISABLED, module)
        );
    }
    ...
    function cancelGlvWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(CANCEL_GLV_WITHDRAWAL_FEATURE_DISABLED, module)
        );
    }
    ...
    function executeGlvWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(EXECUTE_GLV_WITHDRAWAL_FEATURE_DISABLED, module)
        );
    }

    function createGlvShiftFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function executeGlvShiftFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the create deposit module
    // @return key for whether create deposit is disabled
    function createDepositFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the cancel deposit module
    // @return key for whether cancel deposit is disabled
    function cancelDepositFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the execute deposit module
    // @return key for whether execute deposit is disabled
    function executeDepositFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the create withdrawal module
    // @return key for whether create withdrawal is disabled
    function createWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the cancel withdrawal module
    // @return key for whether cancel withdrawal is disabled
    function cancelWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the execute withdrawal module
    // @return key for whether execute withdrawal is disabled
    function executeWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function executeAtomicWithdrawalFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(EXECUTE_ATOMIC_WITHDRAWAL_FEATURE_DISABLED, module)
        );
    }
    ...
    function createShiftFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function cancelShiftFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function executeShiftFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function createOrderFeatureDisabledKey(address module, uint256 orderType)
        internal
        pure
        returns (bytes32)
    {
    ...
    function executeOrderFeatureDisabledKey(address module, uint256 orderType)
        internal
        pure
        returns (bytes32)
    {
    ...
    function executeAdlFeatureDisabledKey(address module, uint256 orderType)
        internal
        pure
        returns (bytes32)
    {
    ...
    function updateOrderFeatureDisabledKey(address module, uint256 orderType)
        internal
        pure
        returns (bytes32)
    {
    ...
    function cancelOrderFeatureDisabledKey(address module, uint256 orderType)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimFundingFeesFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param the claim funding fees module
    function claimCollateralFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimAffiliateRewardsFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimUiFeesFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function subaccountFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function isOracleProviderEnabledKey(address provider)
        internal
        pure
        returns (bytes32)
    {
    ...
    function isAtomicOracleProviderKey(address provider)
        internal
        pure
        returns (bytes32)
    {
    ...
    function oracleTimestampAdjustmentKey(address provider, address token)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(ORACLE_TIMESTAMP_ADJUSTMENT, provider, token));
    }

    // @dev key for oracle provider for token
    // @param token the token
    // @return key for oracle provider for token
    function oracleProviderForTokenKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function tokenTransferGasLimit(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function savedCallbackContract(address account, address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function virtualMarketIdKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function virtualInventoryForPositionsKey(bytes32 virtualTokenId)
        internal
        pure
        returns (bytes32)
    {
    ...
    function virtualInventoryForSwapsKey(
        ...
        return keccak256(
            abi.encode(
                VIRTUAL_INVENTORY_FOR_SWAPS, virtualMarketId, isLongToken
            )
        );
    }
    ...
    function positionImpactFactorKey(address market, bool isPositive)
        internal
        pure
        returns (bytes32)
    {
    ...
    function positionImpactExponentFactorKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function maxPositionImpactFactorKey(address market, bool isPositive)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market address to check
    // @return key for the max position impact factor
    function maxPositionImpactFactorForLiquidationsKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function positionFeeFactorKey(address market, bool forPositiveImpact)
        internal
        pure
        returns (bytes32)
    {
    ...
    function proTraderTierKey(address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    function proDiscountFactorKey(uint256 proTier)
        internal
        pure
        returns (bytes32)
    {
    ...
    function liquidationFeeFactorKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function swapImpactFactorKey(address market, bool isPositive)
        internal
        pure
        returns (bytes32)
    {
    ...
    function swapImpactExponentFactorKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function swapFeeFactorKey(address market, bool forPositiveImpact)
        internal
        pure
        returns (bytes32)
    {
    ...
    function atomicSwapFeeFactorKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function depositFeeFactorKey(address market, bool forPositiveImpact)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(DEPOSIT_FEE_FACTOR, market, forPositiveImpact));
    }

    function withdrawalFeeFactorKey(address market, bool forPositiveImpact)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(WITHDRAWAL_FEE_FACTOR, market, forPositiveImpact)
        );
    }
    ...
    function openInterestInTokensKey(
        ...
        return keccak256(
            abi.encode(OPEN_INTEREST_IN_TOKENS, market, collateralToken, isLong)
        );
    }
    ...
    function poolAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function maxPoolAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    // @param token the token for the pool
    function maxPoolUsdForDepositKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function positionImpactPoolAmountKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function minPositionImpactPoolAmountKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function positionImpactPoolDistributionRateKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function positionImpactPoolDistributedAtKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function swapImpactPoolAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function maxPnlFactorKey(bytes32 pnlFactorType, address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(MAX_PNL_FACTOR, pnlFactorType, market, isLong));
    }

    // @dev the key for min PnL factor after ADL
    // @param market the market for the pool
    // @param isLong whether the key is for the long or short side
    function minPnlFactorAfterAdlKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    function latestAdlAtKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    function isAdlEnabledKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function fundingExponentFactorKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function savedFundingFactorPerSecondKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function fundingIncreaseFactorPerSecondKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function fundingDecreaseFactorPerSecondKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function minFundingFactorPerSecondKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function maxFundingFactorPerSecondKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function thresholdForStableFundingKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    function thresholdForDecreaseFundingKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimableFundingAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @return key for claimable funding amount
    function claimableCollateralAmountKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function claimedCollateralAmountKey(
        ...
        return keccak256(
            abi.encode(
                CLAIMED_COLLATERAL_AMOUNT, market, token, timeKey, account
            )
        );
    }
    ...
    function optimalUsageFactorKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    function baseBorrowingFactorKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    function aboveOptimalUsageBorrowingFactorKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(ABOVE_OPTIMAL_USAGE_BORROWING_FACTOR, market, isLong)
        );
    }
    ...
    function borrowingFactorKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param market the market for the pool
    // @param isLong whether to get the key for the long or short side
    function borrowingExponentFactorKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    function cumulativeBorrowingFactorKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    {
        return keccak256(
            abi.encode(CUMULATIVE_BORROWING_FACTOR_UPDATED_AT, market, isLong)
        );
    }
    ...
    function totalBorrowingKey(address market, bool isLong)
        internal
        pure
        returns (bytes32)
    {
    ...
    function affiliateRewardKey(address market, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function minAffiliateRewardFactorKey(uint256 referralTierLevel)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(MIN_AFFILIATE_REWARD_FACTOR, referralTierLevel)
        );
    }
    ...
    function subaccountActionCountKey(
        ...
        return keccak256(
            abi.encode(SUBACCOUNT_ACTION_COUNT, account, subaccount, actionType)
        );
    }

    function subaccountAutoTopUpAmountKey(address account, address subaccount)
        internal
        pure
        returns (bytes32)
    {
    ...
    // @param account the account to get the key for
    // @return key for affiliate reward amount
    function affiliateRewardKey(address market, address token, address account)
        internal
        pure
        returns (bytes32)
    {
    ...
    function isMarketDisabledKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function minMarketTokensForFirstDepositKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function dataStreamMultiplierKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function priceFeedMultiplierKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function priceFeedHeartbeatDurationKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function feeDistributorSwapTokenIndexKey(bytes32 orderKey)
        internal
        pure
        returns (bytes32)
    {
    ...
    function feeDistributorSwapFeeBatchKey(bytes32 orderKey)
        internal
        pure
        returns (bytes32)
    {
    ...
    function glvMaxMarketTokenBalanceUsdKey(address glv, address market)
        internal
        pure
        returns (bytes32)
    {
        return
            keccak256(abi.encode(GLV_MAX_MARKET_TOKEN_BALANCE_USD, glv, market));
    }

    // @dev key for max market token balance amount
    // it is used to limit amount of funds deposited into each market
    function glvMaxMarketTokenBalanceAmountKey(address glv, address market)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(GLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT, glv, market)
        );
    }

    // @dev key for is glv market disabled
    function isGlvMarketDisabledKey(address glv, address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function glvShiftMaxPriceImpactFactorKey(address glv)
        internal
        pure
        returns (bytes32)
    {
    ...
    function glvShiftLastExecutedAtKey(address glv)
        internal
        pure
        returns (bytes32)
    {
    ...
    function glvShiftMinIntervalKey(address glv)
        internal
        pure
        returns (bytes32)
    {
    ...
    function minGlvTokensForFirstGlvDepositKey(address glv)
        internal
        pure
        returns (bytes32)
    {
    ...
    function syncConfigFeatureDisabledKey(address module)
        internal
        pure
        returns (bytes32)
    {
    ...
    function syncConfigMarketDisabledKey(address market)
        internal
        pure
        returns (bytes32)
    {
    ...
    function syncConfigParameterDisabledKey(string memory parameter)
        internal
        pure
        returns (bytes32)
    {
    ...
    function syncConfigMarketParameterDisabledKey(
        ...
        return keccak256(
            abi.encode(SYNC_CONFIG_MARKET_PARAMETER_DISABLED, market, parameter)
        );
    }
    ...
    function syncConfigUpdateCompletedKey(uint256 updateId)
        internal
        pure
        returns (bytes32)
    {
    ...
    function contributorTokenAmountKey(address account, address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function maxTotalContributorTokenAmountKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function contributorTokenVaultKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function buybackBatchAmountKey(address token)
        internal
        pure
        returns (bytes32)
    {
    ...
    function buybackAvailableFeeAmountKey(address feeToken, address swapToken)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(BUYBACK_AVAILABLE_FEE_AMOUNT, feeToken, swapToken)
        );
    }
    ...
    function withdrawableBuybackTokenAmountKey(address buybackToken)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(
            abi.encode(WITHDRAWABLE_BUYBACK_TOKEN_AMOUNT, buybackToken)
        );
    }
    ...
    function buybackGmxFactorKey(uint256 version)
        internal
        pure
        returns (bytes32)
    {
    ...
    function buybackMaxPriceImpactFactorKey(address token)
        internal
        pure
        returns (bytes32)
    {
